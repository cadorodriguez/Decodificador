...
function criptografar(){
	...
	document.getElementById('output').innerHTML = '<textarea readonly id="enviar-texto">' + resultCripto + 
...
function descriptografar(){
	...
	document.getElementById('receber-texto').innerHTML = '<textarea readonly id="enviar-texto">' + resultadoCriptografado + '</textarea>' + '<button class="copiar" id="copiar" onclick="copiar()">Copiar</button>';
} 
